...
class MineAstrTranslationCompatTest {
    ...
    @Test
    void paintingTranslationUsesConfiguredOverlayDistance() {
        assertEquals(8.0D, MineAstrImageCodec.effectiveTargetDistance(8.0D));
        assertEquals(1.0D, MineAstrImageCodec.effectiveTargetDistance(0.0D));
        assertEquals(8.0D, MineAstrImageCodec.effectiveTargetDistance(Double.NaN));
    }
